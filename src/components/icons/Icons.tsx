...
export const BaseIconSVG: React.FC<HTMLProps<SVGSVGElement> & BaseIconSVGProps> = ({
  className,
  children,
  height,
  width,
...
export const ArrowLeft: React.FC<HTMLProps<SVGSVGElement>> = props => (
...
export const ArrowRight: React.FC<HTMLProps<SVGSVGElement>> = props => (
...
export const ArrowRightCircle: React.FC<HTMLProps<SVGSVGElement>> = props => (
...
export const ChevronLeft: React.FC<HTMLProps<SVGSVGElement>> = props => (
...
export const ChevronRight: React.FC<HTMLProps<SVGSVGElement>> = props => (
  <BaseIconSVG iconType="nhsuk-icon__chevron-right" {...props}>
    <path d="M15.5 12a1 1 0 0 1-.29.71l-5 5a1 1 0 0 1-1.42-1.42l4.3-4.29-4.3-4.29a1 1 0 0 1 1.42-1.42l5 5a1 1 0 0 1 .29.71z" />
  </BaseIconSVG>
);

export const Close: React.FC<HTMLProps<SVGSVGElement>> = props => (
...
export const Cross: React.FC<HTMLProps<SVGSVGElement>> = props => (
...
export const SmallEmdash: React.FC<HTMLProps<SVGSVGElement>> = ({ height, width, ...rest }) => (
  <BaseIconSVG iconType="nhsuk-icon__emdash" height={height || 1} width={width || 16} {...rest}>
    <path d="M0 0h16v1H0z" />
  </BaseIconSVG>
);

export const Emdash: React.FC<HTMLProps<SVGSVGElement>> = ({
  className,
  height,
  width,
  ...rest
...
export const Minus: React.FC<HTMLProps<SVGSVGElement>> = props => (
...
export const Plus: React.FC<HTMLProps<SVGSVGElement>> = props => (
  <BaseIconSVG iconType="nhsuk-icon__minus" {...props}>
    <circle cx="12" cy="12" r="10" />
    <path
      fill="none"
...
export const Search: React.FC<HTMLProps<SVGSVGElement>> = props => (
  <BaseIconSVG iconType="nhsuk-icon__search" {...props}>
    <path d="M19.71 18.29l-4.11-4.1a7 7 0 1 0-1.41 1.41l4.1 4.11a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42zM5 10a5 5 0 1 1 5 5 5 5 0 0 1-5-5z" />
  </BaseIconSVG>
);

export const Tick: React.FC<HTMLProps<SVGSVGElement>> = props => (
