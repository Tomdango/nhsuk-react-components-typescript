...
describe('ListPanel', () => {
  ...
  describe('ListPanel.Panel', () => {
    ...
    it('renders back to top button', () => {
      const component = shallow(<ListPanel.Panel backToTopButton></ListPanel.Panel>);
      expect(component.find('.nhsuk-back-to-top').exists()).toBeTruthy();
      component.unmount();
    });

    it('renders back to top button with custom text', () => {
      const component = shallow(<ListPanel.Panel backToTopButton backToTopButtonText="Custom" />);
